...
class GasBillScreenController extends ChangeNotifier {
  ...
  Future<void> checkCustomerId(BuildContext context) async {
    _payCustomerData = {};
    print("=== CHECK CUSTOMER ID DEBUG ===");
    print("customerIdController.text: ${_customerIdController.text}");
    print("gasProviderController.text: ${_gasProviderController.text}");
    ...
    if (text.length == 6) {
      ...
      DbHelper dbHelper = DbHelper();
      print("Calling fetchPayCustomerDetails with:");
      print("  provider: ${_gasProviderController.text}");
      print("  customerId: ${_customerIdController.text}");
      ...
      print("Fetched _payCustomerDetails: $_payCustomerDetails");
