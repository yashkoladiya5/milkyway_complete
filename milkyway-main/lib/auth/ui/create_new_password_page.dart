...
class _CreateNewPasswordPageState extends State<CreateNewPasswordPage> {
  ...
  setPasswordToFirebase() async {
    ...
    final queryValue = widget.mobileNumber ?? widget.email ?? '';
    final lookupResponse = await AuthLegacyBridge.lookupOrSyncUser(queryValue);

    final userId = lookupResponse['userId'] as String;
    ...
    await prefs.setString(SharedPreferenceKeys.userIdKey, userId);
