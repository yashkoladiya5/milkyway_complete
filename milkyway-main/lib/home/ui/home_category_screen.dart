...
class _HomeCategoryScreenState extends State<HomeCategoryScreen> {
  ...
  Future updateUI() async {
    ...
    // Populate productList with ALL products for subcategory filtering
    productList = productData;

    // Sort and filter for current category
  ...
  Future fetchData() async {
    ...
    List<ProductModel> productData = [];
    productData = await DbHelper().readData();
    print("Total products loaded: ${productData.length}");
    ...
    sortedList = productData
        .where((element) => element.category == widget.pageTitle)
        .toList();
    print("Products in category '${widget.pageTitle}': ${sortedList.length}");
